...
// The wheel is filled fresh every time — sliders start at the neutral middle,
// never at the last run's values. Pre-seeding them anchors the patient to their
// previous answer and suppresses the very change this instrument exists to
// track. Comparison with earlier runs lives on "Моя динамика" (the "Колесо
// баланса" tab), after the answer is in.
